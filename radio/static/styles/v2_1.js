...
if (rad_stations[2]!=undefined){
	var img = rad_stations[2];
}else{
	var img = 'noradio';
}


var select = '<div style="color: '+g_text_color+';" onclick="return rad_show_stations();" id="rad_select" align="left"><div id="rad_stationname">' + '<img src="https://radiobells.com/stations/' + img +'_70.jpg" align="absmiddle" id="rad_select_main_image"><span id="rad_select_main_text">' + rad_stations[1] + '</span></div><div id="rad_dropdown"></div></div></div>';
	// <div id="rad_dropdown"></div></div>
	...
	// 	var img = 'noradio';
	// }
	// select += '<div data-url="' + rad_stations[0] + '" data-img="' + img + '" align="left" onclick="return rad_selectthis(this);" onmouseover="this.style.backgroundColor = \'#434242\'" onmouseout="this.style.backgroundColor = \'#2c2c2c\'" class="rad_selection">';

	// if (rad_stations[2]!=undefined){
	//     select += '<img src="https://radiobells.com/stations/' +rad_stations[2] +'_70.jpg" class="rad_select_small_image" align="absmiddle">';
	// }else{
	//     select += '<img src="https://radiobells.com/stations/noradio_70.jpg" class="rad_select_small_image" align="absmiddle">';
	// }
	// select += rad_stations[1] + '</div>'
